...
with st.sidebar:
    ...
    st.markdown("<h1 style='text-align: center;font-size:68px'>Cosmic</h1>", unsafe_allow_html= True)
    # st.markdown("""
...
if predict_btn:
    ...
    with colb:
        ...
        href="https://www.kaggle.com/datasets/atharvaingle/crop-recommendation-dataset">Dataset</a> </b></h5>""", unsafe_allow_html=True)
